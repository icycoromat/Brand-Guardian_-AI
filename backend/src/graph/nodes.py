...
def audit_content_node(state: VideoAuditState) -> Dict[str, Any]:
    '''
    Performers Retrieval-Augmented Generation using RAG to audit the content
    '''
    ...
    #Check while running if this parameter is depriciated or not(openai_api_version)
